...
``` bash
$ git clone git@github.enterprise.irs.gov:whwtb/Knowledge_Transfer_Session_GIT.git
...
# References
* [IRS GitHub and Jira Resources](https://irsgov.sharepoint.com/sites/sssd-ssb-public/SitePages/GitHubandJiraResources.aspx)
