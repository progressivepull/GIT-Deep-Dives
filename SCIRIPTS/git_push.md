...
* ``` git push ```
 ...
 # Output
 ``` bash
 whwtb@nct001ma4443548 MINGW64 /f/TRAINING/Knowledge_Transfer_Session_GIT (main)
$ cd SCIRIPTS/

whwtb@nct001ma4443548 MINGW64 /f/TRAINING/Knowledge_Transfer_Session_GIT/SCIRIPTS (main)
$ chmod +x git_push.sh
...
remote:
remote: GitHub found 1 vulnerability on whwtb/Knowledge_Transfer_Session_GIT's default branch (1 moderate). To find out more, visit:
remote:      https://github.enterprise.irs.gov/whwtb/Knowledge_Transfer_Session_GIT/security/dependabot/1
remote:
To github.enterprise.irs.gov:whwtb/Knowledge_Transfer_Session_GIT.git
